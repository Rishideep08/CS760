...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{Q2.4.png}
  \caption{D3Leaves}
  \label{fig:D3Leaves}
\end{figure}
...
\red{Ans:} 
 ...
 For D1 - please refer to the figure \ref{fig:D1}. If the  first feature (X1) is greater than or equal to 0.201829 then the output class or label is 1 else it is 0.
 
 
For D2 - refer figure \ref{fig:D2}. Actual D2 is very big it is not able to fit in the single image. So, for D2 it is not possible to do without visualization.

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{Q2.5.png}
  \caption{D1}
  \label{fig:D1}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{Q2.5_1.png}
  \caption{D2}
  \label{fig:D2}
\end{figure}
